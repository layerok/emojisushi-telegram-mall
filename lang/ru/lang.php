...
return [
    ...
    'telegram' => [
        ...
        'texts' => [
            ...
            "add_sticks_question" => "Желаете указать кол-во персон?",
        ...
        'districts' => [
            'choose' => 'Выберите район доставки'
        ],
        ...
        'unexpected_error_message' => 'Извините, произошла непредвиденная ошибка, мы ее устраним как можно быстрее!',
        'use_our_website' => 'Заказать на сайте'
    ],
