...
return [
    ...
    'validation' => [
        'phone_ua' => "Невірний формат українського номера телефона",
        'phone_required' => 'Введіть, будь ласка, Ваш номер телефона'
    ],
    'telegram' => [
        'buttons' => [
            "plus" => "➕",
        ...
        'texts' => [
            ...
            "product_no_longer_exists" => "Продукта '%s' більше не існує"
        ],
        ...
        'unexpected_error_message' => 'Вибачте, сталася непердбачувана помилка, ми її усунемо якомога швидше!',
        'use_our_website' => 'Замовити на сайті'
    ],
